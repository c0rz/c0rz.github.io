...
import { SiPostman, SiNodedotjs, SiPostgresql, SiPhp, SiRedhat, SiMssql, SiPython } from 'react-icons/si'
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-16 flex flex-wrap justify-center gap-8">
                        <div className="flex items-center space-x-8">
                            ...
                            <SiMssql className="w-12 h-12 text-gray-600 dark:text-gray-400" />
                        </div>
                    </div>
                </div>
            </section>
