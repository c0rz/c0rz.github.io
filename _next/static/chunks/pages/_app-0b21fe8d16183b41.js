...
function HiOutlineMenu (props) {
  return (0,esm/* GenIcon */.w_)({"tag":"svg","attr":{"fill":"none","viewBox":"0 0 24 24","strokeWidth":"2","stroke":"currentColor","aria-hidden":"true"},"child":[{"tag":"path","attr":{"strokeLinecap":"round","strokeLinejoin":"round","d":"M4 6h16M4 12h16M4 18h16"}}]})(props);
};
...
function FiMoon (props) {
  return (0,esm/* GenIcon */.w_)({"tag":"svg","attr":{"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":"2","strokeLinecap":"round","strokeLinejoin":"round"},"child":[{"tag":"path","attr":{"d":"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"}}]})(props);
};
...
;// CONCATENATED MODULE: ./constants/navigation.js
const MENU_ITEMS = [
    {
        path: "/",
        label: "Home"
...
;// CONCATENATED MODULE: ./components/ThemeToggle.jsx
...
function ThemeToggle(param) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
        ...
        children: isDark ? /*#__PURE__*/ (0,jsx_runtime.jsx)(FiSun, {
            className: "w-5 h-5 text-yellow-500"
        }) : /*#__PURE__*/ (0,jsx_runtime.jsx)(FiMoon, {
...
function Navbar() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("nav", {
        className: "fixed w-full z-50 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg",
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
            className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
            children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: "relative flex items-center justify-between h-16 sm:h-20",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Logo, {}),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(DesktopMenu, {
                        menuItems: MENU_ITEMS,
                        isActive: isActive,
                        isDark: isDark,
                        toggleTheme: toggleTheme
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(MobileMenu, {
                        menuItems: MENU_ITEMS,
                        isActive: isActive,
                        isDark: isDark,
                        toggleTheme: toggleTheme,
...
const Logo = ()=>/*#__PURE__*/ (0,jsx_runtime.jsx)((link_default()), {
        href: "/",
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
            ...
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                ...
                children: "Cornelius S Alfredo"
            })
        })
    });
const DesktopMenu = (param)=>/*#__PURE__*/ {
    let { menuItems, isActive, isDark, toggleTheme } = param;
    return (0,jsx_runtime.jsxs)("div", {
        className: "hidden md:flex md:items-center md:space-x-6",
        children: [
            menuItems.map((item)=>/*#__PURE__*/ (0,jsx_runtime.jsx)((link_default()), {
                    href: item.path,
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
                        className: "px-3 py-2 rounded-md text-sm font-medium transition-colors\n            ".concat(isActive(item.path) ? "text-blue-600 dark:text-blue-400" : "text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400"),
                        children: item.label
                    })
                }, item.path)),
...
const MobileMenu = (param)=>/*#__PURE__*/ {
    let { menuItems, isActive, isDark, toggleTheme, isMenuOpen, setIsMenuOpen } = param;
    return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                        ...
                        className: "p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors",
                        "aria-label": "Menu",
                        children: isMenuOpen ? /*#__PURE__*/ (0,jsx_runtime.jsx)(HiX, {
                            className: "w-5 h-5 text-gray-700 dark:text-gray-300"
                        }) : /*#__PURE__*/ (0,jsx_runtime.jsx)(HiOutlineMenu, {
                            className: "w-5 h-5 text-gray-700 dark:text-gray-300"
                        })
                    })
                ]
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                className: "\n        absolute top-full left-0 right-0 \n        bg-white dark:bg-gray-900 \n        border-b dark:border-gray-700\n        transition-all duration-300 ease-in-out\n        ".concat(isMenuOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2 pointer-events-none", "\n        md:hidden\n      "),
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                    className: "px-4 py-3 space-y-1",
                    children: menuItems.map((item)=>/*#__PURE__*/ (0,jsx_runtime.jsx)((link_default()), {
                            href: item.path,
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
                                className: "\n                block px-3 py-2 rounded-md text-base font-medium transition-colors\n                ".concat(isActive(item.path) ? "bg-gray-100 dark:bg-gray-800 text-blue-600 dark:text-blue-400" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800", "\n              "),
                                children: item.label
                            })
                        }, item.path))
                })
...
/******/ __webpack_require__.O(0, [774,179], function() { return __webpack_exec__(1118), __webpack_exec__(9974); });
